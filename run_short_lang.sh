...
# array=(en penn wiki2 vi th tl kim-cs kim-de)
array=(zh ja)
...
do
    ...
    ./fasttext cbow -input $input -minCount 1 -dim $dim -output $output -cluster $cluster -freq_thre_in_wd $in_wd -freq_thre_in_cl $in_cl -freq_thre_out $thre_out -maxn 1 -minn 1
    gen_out $output
    continue
    ...
    ./fasttext cbow -input $input -minCount 1 -dim $dim -output $output  -cluster $cluster -maxn 1 -minn 1
    gen_out $output
