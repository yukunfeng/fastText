...
do
    ...
    ./fasttext $mode -input $input -minCount $mincount -dim $dim -output $output  -cluster $cluster -epoch $epoch -maxn 0 -neg $neg -loss $loss
    gen_out $output
    ...
    ./fasttext $mode -input $input -minCount $mincount -dim $dim -output $output -cluster $cluster -freq_thre_in_wd $in_wd -freq_thre_in_cl $in_cl -freq_thre_out $thre_out -epoch $epoch -maxn 0 -neg $neg -loss $loss
    gen_out $output
    ...
    # ./fasttext $mode -input $input -minCount $mincount -dim $dim -output $output  -cluster $cluster -epoch $epoch -maxn $maxn -minn $minn -neg $neg -loss $loss
    # gen_out $output
    ...
    # ./fasttext $mode -input $input -minCount $mincount -dim $dim -output $output -cluster $cluster -freq_thre_in_wd $in_wd -freq_thre_in_cl $in_cl -freq_thre_out $thre_out -epoch $epoch -maxn $maxn -minn $minn -neg $neg -loss $loss
    # gen_out $output


    # time ./fasttext $mode -thread 12 -input $input -minCount $mincount -dim $dim -output $output -cluster $cluster -freq_thre_in_wd $in_wd -freq_thre_in_cl $in_cl -freq_thre_out $thre_out -epoch $epoch -maxn $maxn -minn $minn -neg $neg -loss $loss
    # time ./fasttext $mode -thread 12 -input $input -minCount $mincount -dim $dim -output $output  -cluster $cluster -epoch $epoch -maxn $maxn -minn $minn -neg $neg -loss $loss
done
